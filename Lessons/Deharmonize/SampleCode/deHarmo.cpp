 ...
 * Purpose: To remove the harmony from a person's voice with a user specified window
**/
#include "sound.h"
#include "fft.h"
#define margin 0.03
...
int main(int argc, char *argv[]){
 ...
 if(argc < 3){
  fprintf(stderr, "Usage Error: ./deHar inputFile outFile\n");
  exit(1);
 }
...
sound *autoT(sound *orig, char *pC){
 ...
 fprintf(stderr, "Please enter a harmony window: ");
 cin >> window;
